    ...
    <div className="min-h-screen flex items-center justify-center px-4 py-24">
      ...
      >
        ...
        <div className="text-center mb-8">
          <div className="w-16 h-16 mx-auto rounded-2xl bg-creative-gradient flex items-center justify-center shadow-glow mb-4">
          ...
          <p className="text-muted-foreground mt-2">
            {isSignUp
              ? "Start creating stunning AI artwork today"
